...
public class Constants {
    ...
    public static final int gameWorldWidth = 1024;
    public static final int gameWorldHeight = 768;
    ...
    public static final float helicopterFuelConsumptionRate = 1f;

    public static final int skyscraperSize = 10;
}
